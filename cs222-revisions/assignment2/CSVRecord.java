...
public final class CSVRecord implements Serializable, Iterable<String> {
	 ...
	 *
	 * @return true of this record is valid, false if not. Some programs can
	 *         export files that fail this test but still produce parsable
	 *         files.
	 */
	...
	/**
	 * Copies this record into a new Map. The new map is not connected to the
	 * Record object, so making changes to it will not affect this record.
	 *
	 ...
	 * result is constructed by comment, mapping, recordNumber and by passing
	 * the internal values array to {@link Arrays#toString(Object[])}.
	 */
	@Override
	public String toString() {
		return "CSVRecord [comment=" + comment + ", mapping=" + mapping + ", recordNumber=" + recordNumber + ", values="
